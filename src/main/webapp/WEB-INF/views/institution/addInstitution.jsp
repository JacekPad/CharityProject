...
<section class="login-page">
    ...
    <form:form modelAttribute="institution" action="/admin/edit_institution" method="post">
        ...
        <div class="form-group form-group--buttons">
            <a href="${pageContext.request.contextPath}/admin/institution_list" class="btn btn--without-border">Anuluj dodawanie</a>
            <button class="btn" type="submit">Dodaj instytucje</button>
        </div>
        <form:hidden path="id"/>
    </form:form>
</section>
